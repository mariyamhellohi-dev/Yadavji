...
const allPattis = Object.values(pannaDigits).flat();

export default function SinglePattiPage() {
                    ...
                    <div className="max-w-4xl mx-auto px-4">
                        <Card className="bg-card border-border shadow-md">
                            <CardContent className="p-6 space-y-6">
                                ...
                                <div className="border-t border-border pt-6">
                                    <h3 className="text-center text-accent font-semibold mb-4">Select Panna Digits</h3>
                                    <div className="space-y-8">
                                        {Object.entries(pannaDigits).map(([groupName, digits]) => (
                                            <div key={groupName}>
