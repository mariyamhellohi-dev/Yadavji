...
import { doublePannaDigits } from '@/lib/data'
...
const allPattis = Object.values(doublePannaDigits).flat();

export default function DoublePattiPage() {
    ...
    const handleReset = () => {
        setBids(allPattis.reduce((acc, digit) => ({...acc, [digit]: ''}), {}));
                    ...
                    <div className="max-w-4xl mx-auto px-4">
                        <Card className="bg-card border-border shadow-md">
                            <CardContent className="p-6 space-y-6">
                                ...
                                <div className="border-t border-border pt-6">
                                    <h3 className="text-center text-accent font-semibold mb-4">Select Double Panna Digits</h3>
                                    <div className="space-y-8">
                                        {Object.entries(doublePannaDigits).map(([groupName, digits]) => (
                                            <div key={groupName}>
                                                <h4 className="text-center text-primary font-bold mb-4">{groupName}</h4>
                                                <div className="grid grid-cols-2 sm:grid-cols-4 md:grid-cols-4 gap-x-4 gap-y-6">
                                                    {digits.map(digit => (
